...
def consumer(pipe_1, pipe_2, sleep_start, sleep_end, stop_event):
    ...
    while not stop_event.is_set():
        ...
        if waiting != 0:
            ...
            print(' STOPING CONSUMPTION! size is zero, waiting, queues are empty.')
...
if __name__ == '__main__':
    ...
    producer_process = multiprocessing.Process(target=producer, args=(pipe_1, pipe_2, 0.9, 1.0, stop_event))
    consumer_process = multiprocessing.Process(target=consumer, args=(pipe_1, pipe_2, 0.9, 1.1, stop_event))
