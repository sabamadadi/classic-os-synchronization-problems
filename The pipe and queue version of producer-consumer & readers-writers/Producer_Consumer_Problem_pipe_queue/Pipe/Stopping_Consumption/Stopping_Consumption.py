...
if __name__ == '__main__':
    ...
    producer_process = multiprocessing.Process(target=producer, args=(pipe_1, pipe_2, 1.1, 2.0, stop_event))
    consumer_process = multiprocessing.Process(target=consumer, args=(pipe_1, pipe_2, 0.1, 0.3, stop_event))
