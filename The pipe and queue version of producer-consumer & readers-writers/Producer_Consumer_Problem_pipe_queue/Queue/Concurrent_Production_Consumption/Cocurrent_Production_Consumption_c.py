...
if __name__ == '__main__':
    ...
    process_producer = [producer(queue, i, stop_event, 1.7, 1.9) for i in range(PRODUCER_NUMBER)]
    process_consumer = [consumer(queue, i, stop_event,1.2, 1.5)for i in range(CONSUMER_NUMBER)]
