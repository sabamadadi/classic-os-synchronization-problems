...
if __name__ == '__main__':
    ...
    process_producer = [producer(queue, i, stop_event, 0.1, 0.3) for i in range(PRODUCER_NUMBER)]
    process_consumer = [consumer(queue, i, stop_event,1.1, 2.0)for i in range(CONSUMER_NUMBER)]
